...
export const HOUSING_DATA: Housing[] = [{
  ...
  optionpayantes: [
    {
      ...
      optionpayante: {id: 2, libelle: "Drap de lit", description: "Pour l'ensemble des lits"},
      prix: 30.0
    },
    {
      id: {habitationId: 1, optionpayanteId: 3},
      optionpayante: {id: 3, libelle: "Linge de maison", description: "Linge de toilette pour la salle de bain"},
      prix: 20.0
    },
    {
      id: {habitationId: 1, optionpayanteId: 1},
    optionpayante: {id: 1, libelle: "Ménage", description: "A la fin du séjour"},
    prix: 60.0
  }],
  libelle: "Maison provençale",
  description: "Une description",
  adresse: "12 Rue du Coq qui chante",
  idVille: 56, ville: "Nantes",
  image: "http://localhost/static/images/locations/http://localhost/static/images/locations/maison.png",
  habitantsmax: 8,
  chambres: 3,
  lits: 3,
  sdb: 1,
  ...
  items: [{id: 1, libelle: "Internet", description: "Wifi et Fibre"}],
  optionpayantes: [{
  ...
  idVille: 99, ville: "Paris",
  image: "http://localhost/static/images/locations/http://localhost/static/images/locations/appartement.png",
  habitantsmax: 4,
  chambres: 1,
  lits: 2,
  sdb: 1,
  ...
  adresse: "Rue 3",
  idVille: 4, ville: "Montpellier",
  image: "http://localhost/static/images/locations/maison.png",
  habitantsmax: 5,
  chambres: 2,
  lits: 3,
  sdb: 1,
  ...
  id: 4,
  typehabitat: {id: 1, libelle: "Maison"},
  items: [{id: 3, libelle: "Climatisation", description: "Climatisation réversible"}],
  optionpayantes: [],
  libelle: "Maison 4",
  ...
  adresse: "Rue 4",
  idVille: 3, ville: "Nice",
  image: "http://localhost/static/images/locations/appartement.png",
  habitantsmax: 5,
  chambres: 2,
  lits: 3,
  sdb: 1,
